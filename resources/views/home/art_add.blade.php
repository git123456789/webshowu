	...
	<div class="row">
		<div class="col-sm-12 col-md-12">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" value="" placeholder="请输入文章标题" id="art_title" class="form-control" name="art_title">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="art_tags">TAG标签：</label>
				<div class="col-sm-10">
					<input type="text" value="" placeholder="请输入TAG标签" id="art_tags" class="form-control" name="art_tags">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="copy_from">内容来源：</label>
				<div class="col-sm-10">
					<input type="text" value="" placeholder="请输入内容来源" id="copy_from" class="form-control" name="copy_from">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="copy_url">来源地址：</label>
				<div class="col-sm-10">
					<input type="text" value="" placeholder="请输入来源地址" id="copy_url" class="form-control" name="copy_url">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="art_intro">内容摘要：</label>
				<div class="col-sm-10">
					<input type="text" value="" placeholder="请输入内容摘要" id="art_intro" class="form-control" name="art_intro">
				</div>
			</div>
			<div class="form-group">
